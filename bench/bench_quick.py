...
EXPERT_DIR = os.path.expanduser(os.environ.get("SNIPER_EXPERT_DIR", "~/models/qwen35-35b-moe-stream/experts"))
FALLBACK_PATH = os.environ.get("SNIPER_FALLBACK_PATH", "expert_fallback.bin")
